...
function benford_analyse(varargin)
    ...
    benford_analyse_internal(data,ran,a);

end

function benford_analyse_internal(data,ran,a)

    [mant,mant_test,mant_desc] = benford_mantissae(data,ran,a);
...
function plot_mantissae(mant,test,desc)
    ...
    plot(0,0,'Color','r','LineStyle','none','Marker','x','MarkerSize',12);
    hold on;
        plot(mant.X,mant.Y,'Color',[0.239 0.149 0.659],'LineStyle','none','Marker','.','MarkerSize',6);
        plot(mean(mant.X),mean(mant.Y),'Color',[0.239 0.149 0.659],'LineStyle','none','Marker','.','MarkerSize',12);
    hold off;
